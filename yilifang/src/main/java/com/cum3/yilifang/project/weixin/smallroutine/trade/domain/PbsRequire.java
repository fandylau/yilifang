...
@Table(name = "yilifang_comunity_pbsrequire")
@NameStyle(Style.normal)
public class PbsRequire extends BaseEntity<PbsRequire> {
    /**
     * 描述
     */
    ...
    public String getEffectDays() {
        ...
        return DateUtil.dateDiff(DateUtil.getTime(),
                DateUtil.dateToString(this.effecEndTime, DateStyle.YYYY_MM_DD_HH_MM_SS));
