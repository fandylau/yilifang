package com.cum3.yilifang.project.weixin.smallroutine.pay;
...
import com.cum3.yilifang.framework.common.utils.IpUtils;
...
public class WxPayController {
  ...
  public <T> T createOrder(@RequestBody WxPayUnifiedOrderRequest request) throws WxPayException {
    request.setSpbillCreateIp(IpUtils.getIpAddr(ServletUtils.getRequest()));//设置请求ip地址
    request.setNotifyUrl(wxService.getConfig().getNotifyUrl());//支付成功回调地址
