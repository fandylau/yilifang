 ...
 */
@Wrapper
public class CareApplyWrapper extends BaseWrapper {
    
    public CareApplyWrapper(Map single) {
        super(single);
    }
    public CareApplyWrapper(List multi) {
        super(multi);
    }
    public CareApplyWrapper(PageEntity pageEntity) {
        super(pageEntity);
    }
