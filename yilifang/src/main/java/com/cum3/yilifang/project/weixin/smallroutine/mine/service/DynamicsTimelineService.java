...
import com.cum3.yilifang.project.weixin.smallroutine.mine.domain.DynamicsTimeline;

@Service("dynamicsTimelineService")
public class DynamicsTimelineService extends BaseService<DynamicsTimeline>{
    /**
     * 自定义业务 用于测试 
     * @return
     */
